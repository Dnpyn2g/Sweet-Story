...
<head>
    ...
    <script>
        function toggleContent(id) {
            ...
            button.textContent = content.classList.contains('show') ? 'Скрыть' : 'Показать все';
        }
...
<header>
    <h1>Истории JSON</h1>
    <button onclick="toggleTheme()" style="margin-top: 10px; background-color: #444; color: white; padding: 8px; border: none; cursor: pointer;">Сменить тему</button>
</header>
<main>
    ...
    {% if stories %}
        {% for story in stories %}
            <div class="story">
                ...
                <div id="content-{{ story.id }}" class="content">{{ story.content }}</div>
