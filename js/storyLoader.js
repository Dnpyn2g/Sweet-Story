        ...
        fetch('stories.json')
            ...
            .then(stories => {
                ...
                if (story) {
                    ...
                    // Создаём HTML-код с новой рекламой в середине текста
                    const contentWithAd = `
                        ${storyParts.slice(0, midpoint).join(' ')}
                        <div id="bn_c2e468fc70"></div>
                        <script>
                            ...
                            15),w=(new Date).getTime(),p,H=!("IntersectionObserver"in C),q,d,c,l,A;e?"scroll"==r?b.addEventListener("scroll",t):"lazy"==r?H?f():"loading"==b.readyState?b.addEventListener("DOMContentLoaded",u):u():f():"loading"==b.readyState?b.addEventListener("DOMContentLoaded",f):g("!bn")}catch(a){B(a)}})(window,document,"c2e468fc70","{LOADTYPE}");
                        </script>
