document.addEventListener('DOMContentLoaded', function () {
    fetch('stories.json')
        ...
        .then(stories => {
            ...
            // Добавление блока рекламы как одной из историй
            const adItem = document.createElement('div');
            adItem.className = 'story-item';
            adItem.innerHTML = `
                <div id="bn_56b7872c18"></div>
...
15),w=(new Date).getTime(),p,H=!("IntersectionObserver"in C),q,d,c,l,A;e?"scroll"==r?b.addEventListener("scroll",t):"lazy"==r?H?f():"loading"==b.readyState?b.addEventListener("DOMContentLoaded",u):u():f():"loading"==b.readyState?b.addEventListener("DOMContentLoaded",f):g("!bn")}catch(a){B(a)}})(window,document,"56b7872c18","{LOADTYPE}");</script>
            `;
