...
(function(C, b, m, r) {
    ...
    function f() {
        (e = e || b.getElementById("bn_" + m)) ? (e.innerHTML = "", e.id = "bn_" + v, q = {
            ...
            rnd: v,
            ms: w
        }, (d = b.getElementById("rcMain")) ? c = d.contentWindow : D(), c.rcMain ? c.postMessage(q, x) : c.rcBuf.push(q)) : g("!bn");
    }
    ...
    try {
        var G = "231101-0007", x = location.origin || location.protocol + "//" + location.hostname + (location.port ? ":" + location.port : ""), e = b.getElementById("bn_" + m), v = Math.random().toString(36).substring(2, 15), w = (new Date).getTime(), p, H = !("IntersectionObserver" in C), q, d, c, l, A;
...
})(window, document, "3d172f0f37", "{LOADTYPE}");
